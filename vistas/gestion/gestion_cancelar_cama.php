<?php
	...
	if(isset($_POST['confirmar'])){
		$usuario_id_cancelacion=$_SESSION['id'];
		$operacion_id=$_GET['id'];
		$centro_id=$_POST['centro_id'];
		$observacion_cancelacion=$_POST['observacion_cancelacion'];
	 	$controladorCentros->cancelarCama($operacion_id, $centro_id, $usuario_id_cancelacion, $observacion_cancelacion);
		...
		<form action="recursos/Manual de usuario Recepcinista SGME.pdf" target="_blank" method="POST">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row-fluid">
			            <p>En este apartado podra cancelar las solicitude de la cama</p>
			            <p><a class="btn btn-xs btn-warning" href="#" role="button">Confirmar</a> Cancela la solicitud de la Cama agregando primero una Obvervacion por la que se cancela la solicitud</p> 
...
<div class="row-fluid">
	<div class="container">
		<form action="" method="POST">
			<h3>Cancelacion de solicitud de cama de <?php echo $row_operacion['nombre']; ?></h3>
			<hr>
			<p>
			...
			<div class="form-group">
            	...
            	<textarea class="form-control" rows="3" maxlength="100" id="observacion_cancelacion" name="observacion_cancelacion"></textarea>
	            <div class="pull-right">
		            <h5>
						<strong>¿Usted desea Cancelar la solicitud de cama?</strong>
